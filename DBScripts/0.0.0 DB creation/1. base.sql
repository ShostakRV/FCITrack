...
DROP TABLE CONF_GUI_WS CASCADE CONSTRAINTS ;

DROP TABLE CONT_GUI_VERSION CASCADE CONSTRAINTS ;

DROP TABLE CONT_GUI_WS_PROPERTY CASCADE CONSTRAINTS ;

DROP TABLE PRODUCT CASCADE CONSTRAINTS ;

DROP TABLE PROD_PROCESS_DEF CASCADE CONSTRAINTS ;

DROP TABLE PROPERTY_MAP CASCADE CONSTRAINTS ;

DROP TABLE RELEASE CASCADE CONSTRAINTS ;

DROP TABLE TECHNICAL_WORK CASCADE CONSTRAINTS ;

DROP TABLE WORKING_STATE CASCADE CONSTRAINTS ;
...
CREATE SEQUENCE CONF_GUI_WS_ID_SEQ START WITH 1 NOCACHE ORDER ;
CREATE OR REPLACE TRIGGER CONF_GUI_WS_ID_TRG BEFORE
  INSERT ON CONF_GUI_WS FOR EACH ROW WHEN (NEW.ID IS NULL) BEGIN :NEW.ID := CONF_GUI_WS_ID_SEQ.NEXTVAL;
END;
/

CREATE SEQUENCE CONT_GUI_VERSION_ID_SEQ START WITH 1 NOCACHE ORDER ;
CREATE OR REPLACE TRIGGER CONT_GUI_VERSION_ID_TRG BEFORE
  INSERT ON CONT_GUI_VERSION FOR EACH ROW WHEN (NEW.ID IS NULL) BEGIN :NEW.ID := CONT_GUI_VERSION_ID_SEQ.NEXTVAL;
END;
/

CREATE SEQUENCE CONT_GUI_WS_PROPERTY_ID_SEQ START WITH 1 NOCACHE ORDER ;
CREATE OR REPLACE TRIGGER CONT_GUI_WS_PROPERTY_ID_TRG BEFORE
  INSERT ON CONT_GUI_WS_PROPERTY FOR EACH ROW WHEN (NEW.ID IS NULL) BEGIN :NEW.ID := CONT_GUI_WS_PROPERTY_ID_SEQ.NEXTVAL;
END;
/

CREATE SEQUENCE RELEASE_ID_SEQ START WITH 1 NOCACHE ORDER ;
CREATE OR REPLACE TRIGGER RELEASE_ID_TRG BEFORE
  INSERT ON RELEASE FOR EACH ROW WHEN (NEW.ID IS NULL) BEGIN :NEW.ID := RELEASE_ID_SEQ.NEXTVAL;
END;
/

CREATE SEQUENCE WORKING_STATE_ID_SEQ START WITH 1 NOCACHE ORDER ;
CREATE OR REPLACE TRIGGER WORKING_STATE_ID_TRG BEFORE
